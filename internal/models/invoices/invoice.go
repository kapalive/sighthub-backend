...
type Invoice struct {
	...
	PaidInsuranceStatus types.PaidInsuranceStatus `gorm:"column:paid_insurance_status"                           json:"paid_insurance_status"`
	...
	StatusInvoiceID     int64                     `gorm:"column:status_invoice_id"                                json:"status_invoice_id"`
