// internal/models/medical/vision_exam/preliminary/preliminary_eye_exam.go
package preliminary
...
type PreliminaryEyeExam struct {
	...
	IrisColor                    string  `gorm:"column:iris_color;type:varchar(20);not null;default:'n/a'"        json:"iris_color"`
