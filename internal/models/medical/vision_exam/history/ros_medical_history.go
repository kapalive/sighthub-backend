// internal/models/medical/vision_exam/history/ros_medical_history.go
package history

// ROSMedicalHistory ↔ table: ros_medical_history
...
func (r *ROSMedicalHistory) ToMap() map[string]interface{} {
	return map[string]interface{}{
		...
		"eyes": r.Eyes, "eyes_text": r.EyesText,
		"general": r.General, "general_text": r.GeneralText,
		"genitourinary": r.Genitourinary, "genitourinary_text": r.GenitourinaryText,
		"gastrointestinal": r.Gastrointestinal, "gastrointestinal_text": r.GastrointestinalText,
		"psychiatric": r.Psychiatric, "psychiatric_text": r.PsychiatricText,
		"endocrine": r.Endocrine, "endocrine_text": r.EndocrineText,
		"ear_nose_throat": r.EarNoseThroat, "ear_nose_throat_text": r.EarNoseThroatText,
		"allergy_immun": r.AllergyImmun, "allergy_immun_text": r.AllergyImmunText,
		"integumentary": r.Integumentary, "integumentary_text": r.IntegumentaryText,
		"cardiovascular": r.Cardiovascular, "cardiovascular_text": r.CardiovascularText,
		"musculoskeletal": r.Musculoskeletal, "musculoskeletal_text": r.MusculoskeletalText,
		"respiratory": r.Respiratory, "respiratory_text": r.RespiratoryText,
		"hematological_lymp": r.HematologicalLymp, "hematological_lymp_text": r.HematologicalLympText,
		"neurological": r.Neurological, "neurological_text": r.NeurologicalText,
	}
}
